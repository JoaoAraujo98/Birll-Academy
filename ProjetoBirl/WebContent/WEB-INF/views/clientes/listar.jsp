	...
	<div class="w3-bar w3-light-grey">
		...
		<div class="w3-dropdown-hover">
			...
			<div class="w3-dropdown-content w3-bar-block w3-card-4">
				<a href="/ProjetoBirl/clientes/form" class="w3-bar-item w3-button">Adicionar
					Cliente</a> <a href="/ProjetoBirl/clientes/selecionarnome"
					class="w3-bar-item w3-button">Buscar Cliente por Nome</a> <a
					href="/ProjetoBirl/clientes/formfluxo"
					class="w3-bar-item w3-button">Fluxo Mensal</a>
	...
	<table border=3; align="center">
		...
		<c:forEach var="cliente" items="${clientes}">
			...
			<tr>
				...
				<td><a
					href="/ProjetoBirl/clientes/pagarmensalidade?id=${cliente.id}">Pagar
						Mensalidade</a></td>
				<td><a
					href="/ProjetoBirl/clientes/vermensalidades?id=${cliente.id}">Ver
						Mensalidades</a></td>
			</tr>
		</c:forEach>
